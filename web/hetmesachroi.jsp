<%-- 
    Document   : hetmesachroi
    Created on : Nov 15, 2019, 11:27:27 AM
    Author     : thai9
--%>
...
<div class="container" style="padding: 10% 0%">
    <div class="jumbotron justify-content-center text-center">
        <h4 class="display-4">Sách Đã hết, Vui Lòng Quay Lại Sau.</h4>
    </div>
    <div class="embed-responsive embed-responsive-16by9">
        <iframe width="560" height="315" src="https://www.youtube.com/embed/d3FB2QmC7KQ" frameborder="0" allow="accelerometer; autoplay; encrypted-media; gyroscope; picture-in-picture" allowfullscreen></iframe>
    </div>
    <div class="jumbotron justify-content-center text-center">
        <a href="Sach"><input class="btn btn-primary" value="Quay Lại"></a>
    </div>
</div>
