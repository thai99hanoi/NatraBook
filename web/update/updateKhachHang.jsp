<%-- 
    Document   : updateKhachHang
    Created on : Oct 25, 2019, 10:11:54 PM
    Author     : dell
--%>
                ...
                <c:forEach var="u" items="${update}">
                    <table class="table">
                        <tr>
                            ...
                            <td>
                                <input type="text" name="maKhachHang" value="${u.maKhachHang}"/>
                            </td>
                        </tr>
                        <tr>
                            <th>
                            ...
                            <td>
                                <input type="text" name="hoTen" value="${u.hoTen}" />
                            </td>
                        </tr>
                        <tr>
                            <th>
                            ...
                            <td>
                                <input type="text" name="gioiTinh" value="${u.gioiTinh}" />
                            </td>
                        </tr>
                        <tr>
                            <th>
                        ...
                        <tr>
                            ...
                            <td>
                                <input type="text" name="diaChi" value="${u.diaChi}" />
                            </td>
                        </tr>
                        <tr>
                            <th>
                            ...
                            <td>
                                <input type="text" name="sDT" value="${u.sDT}" />
                            </td>
                        </tr>
                        <tr>
                            <th>
                            ...
                            <td>
                                <input type="text" name="taiKhoan" value="${u.taiKhoan}" />
                            </td>
                        </tr>
                        <tr>
                            <th>
                            ...
                            <td>
                                <input type="text" name="mK" value="${u.mK}" />
                            </td>
                        </tr>
                        ...
                        <tr>
                            ...
                            <td>
                                <input type="text" name="ngayDK" value="${u.ngayDK}" />
                            </td>
                        </tr>
                        <tr>
                            <td>
